...
import AttachmentPage from "../../../AttachmentPage/AttachmentPage";
...
const SiteDetailExpensesList = () => {
  ...
  const displayImage = (_id: any) => {
    const siteId: any = searchParams.get("siteId");
    const key: any = searchParams.get("key");
    window.open(`/attachment?siteId=${siteId}&key=${key}&_id=${_id}`, "_blank");
    // navigate(`/attachment?siteId=${siteId}&key=${key}&_id=${_id}`);
    // if(key == 'client'){
    //   const url = apiurl + "siteexpenses/attachment/"+siteId+"/"+key+"/"+_id
    //   fetch(url).then(res=>res.json()).then(async (data:any)=>{
    //     debugger;
                  ...
                  <Grid container spacing={3}>
                    <Grid item xs={12}>
                        ...
                        <Breadcrumbs aria-label="breadcrumb">
                          ...
                          {/* {!detailexpenses && <Typography color="text.primary">Site Expenses</Typography>} */}
                          {
                            <Link
                              ...
                              onClick={() =>
                                navigate(
                                  `/siteexpenses?siteId=${object.siteId}`,
                                )
                              }
                      ...
                      >
                        ...
                        {/* <br/> */}
                        <p>
                          <b> Site ID</b> : {object && object.siteId} ,&nbsp;
                          &nbsp;&nbsp; &nbsp;
                                        ...
                                        <TableRow>
                                          ...
                                          <TableCell>
                                            {object.key == "client" &&
                                              ...
                                              data.site.client_expenses_status}
                                          </TableCell>
                                          ...
                                          <TableCell>
                                            ...
                                            {object.key == "contractor" && (
                                              <>
                                                {" "}
                                                <img
                                                  src={elm.contractor_signature}
                                                  alt="Preview"
                                                  style={{ width: "300px" }}
                                                />
                                              </>
