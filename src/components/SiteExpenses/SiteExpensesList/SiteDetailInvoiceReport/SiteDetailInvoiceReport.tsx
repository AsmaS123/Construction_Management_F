...
import styles from './SiteDetailInvoiceReport.module.css';
            ...
            >
              <h3>{props.invoiceData.site_name} Site Invoice</h3>
                ...
                >
                  ...
                  <TableBody>
                  {
                    props.invoiceData && props.invoiceData.expenses &&  (props.invoiceData.expenses).map((elm:any, index:any)=>{
                      const sno = index+2
                      return (<>
                      <TableRow >
                          ...
                          <TableCell>
                            ...
                            <TableCell>
                            {Object.keys(props.invoiceData).length>0 && props.invoiceData.site.client_expenses_status}
                            </TableCell>
                            <TableCell>
                            {elm.date}
                            </TableCell>
