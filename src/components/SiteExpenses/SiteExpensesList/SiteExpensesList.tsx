...
const SiteExpensesList = (props: any) => {
  ...
  const [expensesId, setExpensesId]: any = useState({
    id: "",
    key: "",
    site_id: "",
  });
  ...
  const fetchSiteDetails = () => {
    ...
    axiosInstance
      ...
      .then((res: any) => {
        ...
        res.data.contractor.forEach(
          (element: { contractor_expenses_date: string }, i: any): any => {
            ...
            <Grid item xs={12}>
              <div role="presentation">
                <Breadcrumbs aria-label="breadcrumb">
                  ...
                  {!detailexpenses && (
                    <Typography color="text.primary">Site Expenses</Typography>
                  )}
                  {detailexpenses && (
                    <Link
                      underline="hover"
              ...
              <Paper sx={{ p: 2, display: "flex", flexDirection: "column" }}>
                ...
                {/* <br/> */}
                <p>
                  <b> Site ID</b> : {formik.values && formik.values.site_id}{" "}
                  ,&nbsp; &nbsp;&nbsp; &nbsp;<b> Site Type </b>:{" "}
                  {formik.values && formik.values.site_type}, &nbsp; &nbsp;
                  &nbsp; &nbsp;<b> Site Name </b>:{" "}
                  {formik.values && formik.values.site_name}, &nbsp;
                  &nbsp;&nbsp; &nbsp;<b> Site Engineer Name </b> :{" "}
                  {formik.values && formik.values.site_engineer_name}, &nbsp;
                  &nbsp;&nbsp; &nbsp; <b>Client Name </b> :{" "}
                  {formik.values && formik.values.client_name}
                </p>
                {!detailexpenses && (
                  <>
                    <>
                      <TableContainer component={Paper}>
                        ...
                        <Button
                          ...
                          onClick={() => {
                            props.updateReportData(formik.values);
                                  ...
                                  <TableCell>
                                    <button
                                      onClick={() => {
                                        const key = "client";
                                        navigate(
                                          `/sitedetailexpenses?siteId=${formik.values.site_id}&key=${key}&id=${formik.values._id}`,
                                        );
                                      }}
                                    >
                                      expenses
                                          ...
                                          <TableCell>
                                            <button
                                              onClick={() => {
                                                ...
                                                navigate(
                                                  `/sitedetailexpenses?siteId=${formik.values.site_id}&key=${key}&id=${elm._id}`,
                                                );
                                              }}
                                            >
                                              expenses
