          ...
          <Grid container spacing={3}>
            <Grid item xs={12}>
              ...
              <div
                id="invoice"
                style={{
                  backgroundImage: `url('/letter_head.png')`,
                  height: "130vh",
              ...
              >
                ...
                <div className="flex-container">
                  ...
                  <div>
                    <h3>
                      {invoiceDetails && invoiceDetails.site_name} Site Invoice
                    </h3>

                    <p>
                      <b> Site ID</b> :{" "}
                      {invoiceDetails && invoiceDetails.site_id} ,&nbsp;
                      &nbsp;&nbsp; &nbsp;<b> Site Type </b>:{" "}
                      {invoiceDetails && invoiceDetails.site_type}, &nbsp;
                      &nbsp; &nbsp; &nbsp;<b> Site Name </b>:{" "}
                      {invoiceDetails && invoiceDetails.site_name}, &nbsp;
                      &nbsp;&nbsp; &nbsp;<b> Site Engineer Name </b> :{" "}
                      {invoiceDetails && invoiceDetails.site_engineer_name},
                      &nbsp; &nbsp;&nbsp; &nbsp; <b>Client Name </b> :{" "}
                      {invoiceDetails && invoiceDetails.client_name}
                    </p>
