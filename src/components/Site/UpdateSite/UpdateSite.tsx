                  ...
                  <Box>
                    ...
                    <form>
                        ...
                        <Grid container spacing={2}>
                          ...
                          <Grid item xs={12} lg={3} md={3}>
                            <FormControl fullWidth>
                              ...
                              >
                                <MenuItem value="with_material_site">
                                  With Material Site{" "}
                                </MenuItem>
                                <MenuItem value="supervision_site">
                                  Supervision Site
                                </MenuItem>
                              </Select>
                            </FormControl>
                          ...
                          <Grid item xs={12} lg={3} md={3}>
                            <TextField
                              ...
                              error={
                                ...
                                Boolean(formik.errors.site_name)
                              }
                              helperText={
                                formik.touched.site_name &&
                          ...
                          <Grid item xs={12} lg={3} md={3}>
                            <TextField
                              ...
                              disabled={!isUpdate}
                              error={
                                formik.touched.site_engineer_name &&
                                Boolean(formik.errors.site_engineer_name)
                              }
                              helperText={
                                formik.touched.site_engineer_name &&
                                formik.errors.site_engineer_name
                              }
                            />
                          </Grid>
                        </Grid>
                        ...
                        <Grid container spacing={2}>
                          <Grid item xs={12} lg={3} md={3}>
                            <TextField
                              ...
                              disabled={!isUpdate}
                              error={
                                formik.touched.site_engineer_email &&
                                Boolean(formik.errors.site_engineer_email)
                              }
                              helperText={
                                formik.touched.site_engineer_email &&
                                formik.errors.site_engineer_email
                              }
                            />
                          </Grid>
                          <Grid item xs={12} lg={3} md={3}>
                            <TextField
                              ...
                              error={
                                ...
                                Boolean(formik.errors.site_address)
                              }
                              helperText={
                                formik.touched.site_address &&
                        ...
                        <Grid container spacing={2}>
                          <Grid item xs={12} lg={3} md={3}>
                            <TextField
                              ...
                              disabled={!isUpdate}
                              error={
                                formik.touched.client_contact_no &&
                                Boolean(formik.errors.client_contact_no)
                              }
                              helperText={
                                formik.touched.client_contact_no &&
                                formik.errors.client_contact_no
                              }
                            />
                          </Grid>
                          <Grid item xs={12} lg={3} md={3}>
                            <TextField
                              ...
                              disabled={!isUpdate}
                              error={
                                formik.touched.site_start_date &&
                                Boolean(formik.errors.site_start_date)
                              }
                              helperText={
                                formik.touched.site_start_date &&
                                formik.errors.site_start_date
                              }
                            />
                          </Grid>
                          <Grid item xs={12} lg={3} md={3}>
                            <TextField
                              ...
                              disabled={!isUpdate}
                              error={
                                formik.touched.site_end_date &&
                                Boolean(formik.errors.site_end_date)
                              }
                              helperText={
                                formik.touched.site_end_date &&
                                formik.errors.site_end_date
                              }
                            />
                          </Grid>
                        </Grid>
                      ...
                      >
                        <Grid container spacing={2}>
                          {formik.values.contractor &&
                            formik.values.contractor.length > 0 &&
                                  ...
                                  <Grid item xs={12} lg={3} md={3}>
                                    ...
                                    <FormControl fullWidth>
                                      ...
                                      <Select
                                        ...
                                        // helperText={formik.touched.gender && formik.errors.gender}
                                      >
                                        <MenuItem value="rcc_contractor">
                                          RCC Contractor
                                        </MenuItem>
                                        <MenuItem value="bbm_plaster_contractor">
                                          BBM & Plaster Contractor
                                        </MenuItem>
                                        <MenuItem value="tiles_contractor">
                                          Tiles Contractor
                                        </MenuItem>
                                        <MenuItem value="plumbing_contractor">
                                          Plumbing Contractor
                                        </MenuItem>
                                        <MenuItem value="electric_contractor">
                                          Electric Contractor
                                        </MenuItem>
                                        <MenuItem value="color_contractor">
                                          Color Contractor
                                        </MenuItem>
                                        <MenuItem value="steel_grill_contractor">
                                          Steel Grill Contractor
                                        </MenuItem>
                                        <MenuItem value="window_contractor">
                                          Window Contractor
                                        </MenuItem>
                                        <MenuItem value="door_Contractor">
                                          Door Contractor
                                        </MenuItem>
